...
def midprice_change_direction(training_data):
    ...
    for index in training_data.index:
        training_data.at[index, 'price pattern chance'] = pattern_chance['midprice change direction'].loc[training_data['price change string'].loc[index]]
    # print(training_data.head())
...
def add_distribution_statistics(training_data):
    ...
    # I have a weird idea that this statistic might be useful:

    # Computing Weird Skews
    training_data['level 1 skew'] = ((training_data['limit order level 1 bid price'] - training_data['level 1 mean'])**3 * training_data['limit order level 1 bid volume'] + (training_data['limit order level 1 ask price'] - training_data['level 1 mean'])**3 * training_data['limit order level 1 ask volume'] )/training_data['level 1 volume']
    training_data['level 2 skew'] = ((training_data['limit order level 2 bid price'] - training_data['level 2 mean'])**3 * training_data['limit order level 2 bid volume'] + (training_data['limit order level 2 ask price'] - training_data['level 2 mean'])**3 * training_data['limit order level 2 ask volume'] )/training_data['level 2 volume']
    training_data['level 3 skew'] = ((training_data['limit order level 3 bid price'] - training_data['level 3 mean'])**3 * training_data['limit order level 3 bid volume'] + (training_data['limit order level 3 ask price'] - training_data['level 3 mean'])**3 * training_data['limit order level 3 ask volume'] )/training_data['level 3 volume']
    training_data['level 4 skew'] = ((training_data['limit order level 4 bid price'] - training_data['level 4 mean'])**3 * training_data['limit order level 4 bid volume'] + (training_data['limit order level 4 ask price'] - training_data['level 4 mean'])**3 * training_data['limit order level 4 ask volume'] )/training_data['level 4 volume']
...
def normalise_data(training_data):
    ...
    training_data['level 1 volume split'] = training_data['level 1 volume split'] / training_data['level 1 volume']
    training_data['level 2 volume split'] = training_data['level 2 volume split'] / training_data['level 2 volume']
    training_data['level 3 volume split'] = training_data['level 3 volume split'] / training_data['level 3 volume']
    training_data['level 4 volume split'] = training_data['level 4 volume split'] / training_data['level 4 volume']
    training_data['overall volume split'] = training_data['overall volume split'] / training_data['overall volume']
...
def drop_stuff(training_data):
    if True:
        ...
        training_data = training_data.drop('level 2 skew', axis = 1)
        training_data = training_data.drop('level 3 skew', axis = 1)
        training_data = training_data.drop('level 4 skew', axis = 1)
...
def book_volume_statistics(training_data):
    training_data['level 1 volume split'] = training_data['limit order level 1 bid volume'] - training_data['limit order level 1 ask volume']
    training_data['level 2 volume split'] = training_data['limit order level 2 bid volume'] - training_data['limit order level 2 ask volume']
    training_data['level 3 volume split'] = training_data['limit order level 3 bid volume'] - training_data['limit order level 3 ask volume']
    training_data['level 4 volume split'] = training_data['limit order level 4 bid volume'] - training_data['limit order level 4 ask volume']
    training_data['overall volume split'] = training_data['level 1 volume split'] + training_data['level 2 volume split'] + training_data['level 3 volume split'] + training_data['level 4 volume split']
